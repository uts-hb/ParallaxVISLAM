% function [GMap_End] = FuncTransform_PF3D_origin(GMap,Ref)

%%
clear all; clc; close all; 

load 'v101/localmap_1_.mat' 
file_new = strcat('v101/localmap_',int2str(1));
GMap.I = Info;
GMap.Ref = Ref;
GMap.st = st; 
...
%% zero value after transformation
t =-R*t;
[Alpha,Beta,Gamma] = InvRotMatrixYPR22(R');
...
%             end;
    ...
    st = GMap_End.st(7:end,:);
    Ref = GMap_End.Ref;
    I = GMap_End.I(7:end,7:end);

    save(file_new,"st","Ref","I");
