...
load imu_pre_2808_06.mat 
load trajectory_2808_06.mat
...
GTName = strcat('DataPrepareBA/ORB_2808_06/','GT_P0_PA.mat');
load(GTName); 
...
file = strcat('DataPrepareBA/ORB_2808_06/Image',int2str(start_ImageNum));
load(file);
Image_T_start = [eul2rotm(Image(1,1:3)),Image(1,4:6)'; 0 0 0 1]; 
for i=start_ImageNum:end_ImageNum;
    file = strcat('DataPrepareBA/ORB_2808_06/Image',int2str(i));
	load(file);
	fprintf('%s\n', file);
...
file = strcat('local_map_06_',int2str(start_ImageNum),'_',int2str(end_ImageNum));
diary(file);
%% Least Squares GN
tic
