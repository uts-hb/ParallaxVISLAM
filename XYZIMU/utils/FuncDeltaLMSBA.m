...
%     S = [S(7:57,7:57),S(7:57,59:nRowNumP);
%          S(59:nRowNumP,7:57),S(59:nRowNumP,59:nRowNumP)];
%     ES = [ES(7:57);ES(59:nRowNumP)];
...
%     DeltaP = [zeros(6,1);DeltaP(1:51);0;DeltaP(52:nRowNumP-7)];
end;
